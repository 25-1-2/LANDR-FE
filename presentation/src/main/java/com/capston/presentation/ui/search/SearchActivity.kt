            ...
            CapstonTheme {
                LaunchedEffect(lectureId) {
                    if (lectureId != -1 && fromRecommendation) {
                        ...
                        searchViewModel.selectLecture(lectureItem)
                        searchViewModel.getLessonsByLectureId(lectureId)
                ...
                // 기본은 Search 화면부터 시작
                SearchNavHost(navController, planViewModel, searchViewModel, loadingStateManager)
