...
class PatchTimePlanUseCase @Inject constructor(
    private val repository: PlanRepository
) {
    operator fun invoke(planId: Int, patchTimePlanDto: PatchTimePlanDto): Flow<MessageResponse> = flow {
        val response = repository.patchTimePlan(planId, patchTimePlanDto)
